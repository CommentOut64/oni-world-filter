...
export const GEYSER_DISPLAY_NAMES: Record<string, GeyserDisplayName> = {
    ...
    murky_brine: { zh: "污染浓盐水喷口", en: "Polluted Brine Vent" },
    small_reef_geyser: { zh: "潮汐泉", en: "Tidal Spring" },
    underwater_vent: { zh: "热气裂缝", en: "Thermal Gas Fissure" },
};
...
export const MIXING_SLOT_DISPLAY_NAMES: Record<string, MixingSlotDisplayName> = {
    ...
    "dlc2::worldMixing/CeresMixingSettings": {
        zh: "谷神星碎片",
        en: "Ceres Fragment",
    },
    ...
    "dlc4::worldMixing/PrehistoricMixingSettings": {
        zh: "古迹星碎片",
        en: "Relica Fragment",
    },
    DLC5_ID: { zh: "水生行星包", en: "The Aquatic Planet Pack" },
    ...
    "dlc5::subworldMixing/KelpForestMixingSettings": {
        zh: "海藻林生态",
        en: "Kelp Forest Biome",
    },
    "dlc5::subworldMixing/AbyssMixingSettings": {
        zh: "深渊生态",
        en: "Abyss Biome",
    },
    "dlc5::worldMixing/AquaticMixingSettings": {
        zh: "汪洋星碎片",
        en: "Marinea Fragment",
    },
};
