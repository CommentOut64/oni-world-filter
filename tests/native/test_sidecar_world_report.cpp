...
int RunAllTests()
{
...

    {
        ...
        const std::string expectedGeysers =
            "small_reef_geyser,33,103,175,103,99\n"
            "small_reef_geyser,33,34,112,34,162\n"
            "small_reef_geyser,33,30,154,30,120\n"
            ...
            "small_reef_geyser,33,109,111,109,163\n"
            "small_reef_geyser,33,88,148,88,126\n"
            "small_reef_geyser,33,121,112,121,162\n"
            "small_reef_geyser,33,29,168,29,106\n"
            "small_reef_geyser,33,131,108,131,166\n"
            "small_reef_geyser,33,42,129,42,145\n"
            "small_reef_geyser,33,75,159,75,115\n"
            "underwater_vent,34,105,36,105,238\n"
            "underwater_vent,34,146,41,146,233\n"
            "underwater_vent,34,125,34,125,240\n"
            "murky_brine,32,71,26,71,248\n"
            "salt_water,6,22,216,22,58\n"
            "warp_portal,30,140,176,140,98\n"
            "chlorine_gas,14,17,41,17,233\n"
            "chlorine_gas,14,70,193,70,81\n"
            "hot_hydrogen,11,126,169,126,105\n"
            "molten_cobalt,20,124,55,124,219\n"
            "hot_hydrogen,11,145,62,145,212\n"
            "hot_steam,1,142,200,142,74\n"
            "filthy_water,4,50,187,50,87";
